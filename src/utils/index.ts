...
import { getDeviceType } from 'chargerwallet-hd-core';
import type { Features } from 'chargerwallet-hd-core';
...
export const getDeviceFirmwareVersion = (
  ...
  if (features.chargerwallet_version) {
    return features.chargerwallet_version.split('.') as unknown as number[];
  }
  return [
