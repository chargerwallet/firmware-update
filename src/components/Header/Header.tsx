...
export default function Header() {
  const intl = useIntl();
  const navigation = [
    { name: intl.formatMessage({ id: 'TR_HOME' }), href: 'https://chargerwallet.com/' },
    {
      name: intl.formatMessage({ id: 'TR_SUPPORT' }),
      href: 'https://help.chargerwallet.com/hc/zh-cn',
    },
  ];
                ...
                <div className="flex flex-1 justify-between">
                  <div className="flex flex-shrink-0 items-center">
                    <img
                      ...
                      src="https://help.chargerwallet.com/hc/article_attachments/4578205272847/ChargerWallet__1_.png"
                      alt="Your Company"
                    />
                    <img
