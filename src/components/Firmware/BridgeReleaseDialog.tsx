  ...
  return (
    <ConfirmDialog
      ...
      title={intl.formatMessage({
        id: 'TR_REQUIRES_UPDATING_OF_CHARGERWALLET_BRIDGE',
      })}
      okCancel
    ...
    >
      <div>
        {intl.formatMessage(
          {
            id: 'TR_CHARGERWALLET_BRIDGE_STR_IS_NOW_AVAILABLE_DO_YOU_WANT_TO_DOWNLOAD',
          },
          {
            0: version,
          }
      ...
      <Button
        ...
        type="primary"
        onClick={() => {
          window.open('https://chargerwallet.com/download/?client=bridge', '_blank');
        }}
      >
