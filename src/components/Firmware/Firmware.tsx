...
import { getDeviceType, KnownDevice } from 'chargerwallet-hd-core';
...
export default function Firmware() {
  ...
  useEffect(() => {
    ...
    switch (originType) {
      case 'classic':
        typeFlag = 'ChargerWallet Classic';
        break;
      case 'classic1s':
        typeFlag = 'ChargerWallet Classic 1S';
        break;
      case 'mini':
        typeFlag = 'ChargerWallet Mini';
        break;
      case 'touch':
        typeFlag = 'ChargerWallet Touch';
        break;
      case 'pro':
        typeFlag = 'ChargerWallet Pro';
        break;
      case 'unknown':
        typeFlag = 'Unknown';
        break;
  ...
  const isGreaterThan340 = semver.gte(
    device?.features?.chargerwallet_version ?? '0.0.0',
    '3.4.0'
  );
          ...
          <div className="flex flex-row-reverse">
            <div className="md:w-1/2 sm:w-full">
              ...
              <Description
                ...
                value={device?.features.chargerwallet_version ?? '-'}
              />
              <Description
                text={intl.formatMessage({
          ...
          {['touch', 'pro'].includes(getDeviceType(device?.features)) && (
            ...
            >
              {isBootLoader ? (
                ...
                <EmptyTips version={device?.features?.chargerwallet_version ?? '-'} />
              )}
